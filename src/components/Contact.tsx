        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div className="bg-card rounded-2xl p-6 shadow-card flex items-start gap-4">
              ...
              <div>
                ...
                <a href={`tel:${business.phone}`} className="text-foreground hover:text-primary-accessible transition-colors">
            ...
            <div className="bg-card rounded-2xl p-6 shadow-card flex items-start gap-4">
              ...
              <div>
                ...
                <a href={business.whatsappUrl} target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-primary-accessible transition-colors">
                  {business.phoneDisplay}
                </a>
              </div>
            </div>
            ...
            <div className="bg-card rounded-2xl p-6 shadow-card flex items-start gap-4">
              ...
              <div>
                ...
                <a href={`mailto:${business.email}`} className="text-foreground hover:text-primary-accessible transition-colors">
                  {business.email}
                </a>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card rounded-3xl overflow-hidden shadow-card border border-border">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3750.8877!2d-43.9346!3d-19.9297!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xa699e7e5e8bdef%3A0x1e5d0e8c1e2e8f0e!2sR.%20Padre%20Rolim%2C%20620%20-%20Santa%20Efig%C3%AAnia%2C%20Belo%20Horizonte%20-%20MG%2C%2030130-094!5e0!3m2!1spt-BR!2sbr!4v1702000000000!5m2!1spt-BR!2sbr" width="100%" height="250" style={{
              border: 0
            }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Localização Conectize" className="w-full" />
              <div className="p-4">
                <a href={business.mapsDirectionsUrl} target="_blank" rel="noopener noreferrer" className="text-primary-accessible hover:underline text-sm font-medium flex items-center gap-2">
              ...
              <div className="text-center">
                ...
                <div className="space-y-4">
                  <Button variant="whatsapp" size="xl" className="w-full" asChild>
                    <a href={buildWhatsAppUrl('Olá! Gostaria de um orçamento para conserto de celular.')} target="_blank" rel="noopener noreferrer">
