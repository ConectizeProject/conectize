          ...
          <div className="space-y-6">
            ...
            <div className="bg-card rounded-2xl p-6 shadow-card flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Segunda a Sexta: 9:30h às 18:30h
              ...
              <div className="text-center">
                ...
                <div className="space-y-4">
                  <Button variant="whatsapp" size="xl" className="w-full" asChild>
                    <a href="https://wa.me/5531986140889?text=Olá! Gostaria de um orçamento para conserto de celular." target="_blank" rel="noopener noreferrer">
