-- Conteúdo equivalente a add_payment_methods.sql (nome sem timestamp era ignorado pelo CLI).
-- Necessário antes de 20260305000000_financeiro_banks_and_transactions.sql (alter em payment_methods).
...
grant select, insert, update, delete on public.payment_methods to postgres, service_role;
