-- Aplica só a tabela de troca na venda (idempotente).
-- Use no SQL Editor do Supabase se `supabase db push` não rodou 20260519120000_resale_device_trade_ins.
